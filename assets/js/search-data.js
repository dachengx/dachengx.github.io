    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-first-indication-of-solar-8b-neutrinos-via-coherent-elastic-neutrino-nucleus-scattering-with-xenonnt-is-published-in-prl-as-editors-suggestion",
          ...
          description: "",
          section: "News",},{id: "news-poster-xtract-the-measurement-of-krypton-in-xenon-with-ppq-sensitivity-public-pdf-won-the-people-s-choice-award-at-the-poster-session-of-xesat-2026",
          title: 'Poster XTRACT: The Measurement of Krypton in Xenon with ppq Sensitivity (public PDF)...',
          description: "",
          section: "News",},{id: "news-the-definitive-solar-8b-neutrino-fog-measurement-with-xenonnt-is-now-published",
          title: 'The definitive solar 8B neutrino fog measurement with XENONnT is now published.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/dacheng_xu.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%64%78%32%32%32%37@%63%6F%6C%75%6D%62%69%61.%65%64%75", "_blank");
        },
      },{
        id: 'social-inspire',
        title: 'Inspire HEP',
        section: 'Socials',
        handler: () => {
          window.open("https://inspirehep.net/authors/1862233", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=ZtxKkesAAAAJ", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/dachengx", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0001-7361-9195", "_blank");
        },
      },{
      id: 'light-theme',
